% run_pressproc_brukAuto_threshold.m
% Jamie Near, McGill University 2014.
% 
% USAGE:
% [out,out_w,out_noproc,out_w_noproc]=run_pressproc_brukAuto_threshold(filestring,filestringw,aaDomain,tmaxin,iterin);
% 
% DESCRIPTION:
...
function [out,outw,out_noproc,outw_noproc]=run_pressproc_brukAuto_checkResult_v2(filestring,filestringw,aaDomain,tmaxin,iterin);
...
if writ=='y' || writ=='Y'
    ...
    if MeanRatioProc > MeanRatioNoProc
        ...
        writeText='Processed';
        [~]=io_writelcm(out,['press/press_lcm'],out.te);
    else 
        [~]=io_writelcm(out_noproc,['press/press_lcm'],out_noproc.te);
    ...
    if water
        mkdir(['press_w']);
        RF=io_writelcm(outw,['press_w/press_w_lcm'],outw.te);
    end
end
