...
function [out_proc, ref_proc, out_scanner, ref_scanner, out_raw, ref_raw] = compMRS_procBrukerRaw(inDir)


% %% Get the on-scanner processed data first
% [out_scanner, ref_scanner, nav_scanner, coilcombos_scanner, isECCed] = compMRS_loadspecBruker(inDir, 'n');
% 
...
[out_raw, ref_raw, nav_raw, coilcombos_raw, isECCed, isRFLed] = compMRS_loadspecBruker(inDir, 'y');
